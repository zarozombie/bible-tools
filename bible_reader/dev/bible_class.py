...
class Book:
        ...
        def print_array(self):
            """
            This is a test to print out the remaing array of scripture refrence
            """
            return self.verse
...
#            read_bible= open_bible.read()
        ...
        def create_ch_idex(self):
            ...
            """
            next_verse = int(self.verse[0]) + 1                     #find start of next verse
            verse_str = str(self.verse[0] + ":")                      #create verse serch index
